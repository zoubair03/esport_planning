            ...
            <div class="col-lg-8 mx-auto">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <a href="<?php echo URLROOT; ?>/admin/posts" class="btn btn-sm btn-light mb-3">
                        <i class="fa fa-arrow-left me-3"></i> Back to List
                    </a>
                ...
                <!-- add position-relative so the badge can be absolutely positioned inside the card -->
                <div class="card bg-mode shadow-sm mb-4 position-relative" id="post-<?php echo $post->postId; ?>">
                    <?php if(!empty($post->approved)): ?>
                        <!-- Approved badge: top-right inside the card -->
                        <div class="position-absolute top-0 end-0 p-3" style="z-index: 1050;">
                            <span class="badge rounded-pill bg-success text-white shadow-sm">Approved</span>
                        </div>
                    <?php endif; ?>
                     <!-- Card Header -->
